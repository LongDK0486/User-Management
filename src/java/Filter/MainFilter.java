...
public class MainFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if(resource.endsWith(".html")||resource.endsWith(".jsp")||resource.endsWith(".css")||resource.endsWith(".jpg")){
                url=resource;
            }
            if(url!=null){
                RequestDispatcher rd=hs.getRequestDispatcher(url);
